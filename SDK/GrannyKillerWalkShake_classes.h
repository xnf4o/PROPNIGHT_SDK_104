...
class UGrannyKillerWalkShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass GrannyKillerWalkShake.GrannyKillerWalkShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GrannyKillerWalkShake(int EntryPoint);
};
