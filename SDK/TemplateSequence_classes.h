...
{
public:
	unsigned char                                      UnknownData_FDW7[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_191S[0x3C];                                    // 0x0034(0x003C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H2W6[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PN8K[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OFTE[0x458];                                   // 0x0028(0x0458) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5PPI[0x60];                                    // 0x0578(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PCH4[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C8CF[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OHDB[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QWW5[0x8];                                     // 0x0680(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NM2O[0x8];                                     // 0x0160(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EPZ3[0x70];                                    // 0x0040(0x0070) MISSED OFFSET (PADDING)
