...
class UGrannyJumpShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass GrannyJumpShake.GrannyJumpShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GrannyJumpShake(int EntryPoint);
};
