...
class UBansheeMaxWalkShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BansheeMaxWalkShake.BansheeMaxWalkShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BansheeMaxWalkShake(int EntryPoint);
};
