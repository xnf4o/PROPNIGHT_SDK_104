...
class UChaseShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass ChaseShake.ChaseShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_ChaseShake(int EntryPoint);
};
