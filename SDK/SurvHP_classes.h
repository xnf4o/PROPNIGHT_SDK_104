...
// WidgetBlueprintGeneratedClass SurvHP.SurvHP_C
// 0x0020 (FullSize[0x0280] - InheritedSize[0x0260])
class USurvHP_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SurvHP.SurvHP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_SurvHP(int EntryPoint);
};
