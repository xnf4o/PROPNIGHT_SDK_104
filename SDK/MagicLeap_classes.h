...
public:
	...
	unsigned char                                      UnknownData_P54J[0x8];                                     // 0x0120(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2WOS[0x50];                                    // 0x0180(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UHPP[0x8];                                     // 0x01F8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_SM66[0x6];                                     // 0x0212(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X2ZV[0x3];                                     // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LFZZ[0x3];                                     // 0x0229(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6S53[0x5];                                     // 0x0233(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FCoreUObject_FColor>                 BlockVertexColors;                                         // 0x0238(0x0010) (Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_4GTX[0x7];                                     // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OGPW[0x14];                                    // 0x027C(0x0014) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UH9J[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6S0H[0x68];                                    // 0x00B0(0x0068) MISSED OFFSET (PADDING)
