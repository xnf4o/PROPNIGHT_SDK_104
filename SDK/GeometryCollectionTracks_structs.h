...
{
	unsigned char                                      UnknownData_8IM5[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I9GZ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
