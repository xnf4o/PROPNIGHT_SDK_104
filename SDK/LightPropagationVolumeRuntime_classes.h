...
{
public:
	unsigned char                                      UnknownData_98DH[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8Y70[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
