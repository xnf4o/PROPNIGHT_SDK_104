...
class UPingShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass PingShake.PingShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PingShake(int EntryPoint);
};
