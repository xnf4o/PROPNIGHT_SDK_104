...
class UKillerMaxWalkShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass KillerMaxWalkShake.KillerMaxWalkShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_KillerMaxWalkShake(int EntryPoint);
};
