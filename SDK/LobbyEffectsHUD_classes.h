...
class ULobbyEffectsHUD_C : public UUserWidget
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass LobbyEffectsHUD.LobbyEffectsHUD_C");
		return ptr;
	}
	...
	void StartFadeIn();
	void StartFadeOut();
	void ExecuteUbergraph_LobbyEffectsHUD(int EntryPoint);
};
