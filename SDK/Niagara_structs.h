...
{
	unsigned char                                      UnknownData_4RBL[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraMaterialOverride
{
	...
	unsigned char                                      UnknownData_EBKY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVariableLayoutInfo
{
	...
	unsigned char                                      UnknownData_1ZLT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_WKZK[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UJD7[0x28];                                    // 0x0050(0x0028) MISSED OFFSET (PADDING)
...
struct FNCPoolElement
{
	...
	unsigned char                                      UnknownData_L4RL[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FNCPool
{
	...
	unsigned char                                      UnknownData_38NN[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSetCVarCondition
{
	...
	unsigned char                                      UnknownData_XLPY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8RW3[0xB];                                     // 0x001D(0x000B) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSet
{
	...
	unsigned char                                      UnknownData_G760[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GCXL[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableAttributeBinding
{
	...
	unsigned char                                      UnknownData_7A48[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_542L[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ADHH[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraTypeDefinition
{
	...
	unsigned char                                      UnknownData_YNEM[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraComponentPropertyBinding
{
	...
	unsigned char                                      UnknownData_G3J4[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptExecutionParameterStore : public FNiagaraParameterStore
{
	...
	unsigned char                                      UnknownData_5R2Y[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_KX60[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IOSQ[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_QY0Y[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetID
{
	...
	unsigned char                                      UnknownData_4HS3[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraDataSetCompiledData
{
	...
	unsigned char                                      UnknownData_0RMV[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YKLV[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterScalabilityOverride : public FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_BQ1U[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEventGeneratorProperties
{
	...
	unsigned char                                      UnknownData_BYMT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraEventScriptProperties : public FNiagaraEmitterScriptProperties
{
	...
	unsigned char                                      UnknownData_5KI4[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UQVD[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9L5H[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraSystemTrackImplementation : public FMovieSceneTrackImplementation
{
	...
	unsigned char                                      UnknownData_LSN0[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_FCGS[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_Y79X[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_4CR7[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraVectorParameterSectionTemplate : public FMovieSceneNiagaraParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_M5KX[0x4];                                     // 0x02C4(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemUpdateContext
{
	...
	unsigned char                                      UnknownData_AMFW[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraFunctionSignature
{
	...
	unsigned char                                      UnknownData_VVN1[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraGraphViewSettings
{
	...
	unsigned char                                      UnknownData_NLWI[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraScalabilityManager
{
	...
	unsigned char                                      UnknownData_IJEA[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (PADDING)
...
struct FNiagaraModuleDependency
{
	...
	unsigned char                                      UnknownData_DN95[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_MLO4[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XVF3[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UObject*>                             RootObjects;                                               // 0x0008(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GHJH[0x68];                                    // 0x0018(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1DDG[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableMetaData
{
	...
	unsigned char                                      UnknownData_7KPY[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TTHB[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UJ6G[0x3];                                     // 0x00D0(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_XMB2[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D2H7[0x2];                                     // 0x00DE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7VT2[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraParameterScopeInfo
{
	...
	unsigned char                                      UnknownData_R45A[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_RK71[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_SUUQ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U676[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FNiagaraVariant
{
	...
	unsigned char                                      UnknownData_6IOT[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_P73P[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_64SM[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraVMExecutableDataId
{
	...
	unsigned char                                      UnknownData_IMBY[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraEmitterHandle
{
	...
	unsigned char                                      UnknownData_9H3O[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WBIK[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraRibbonUVSettings
{
	...
	unsigned char                                      UnknownData_P4II[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_K7YM[0x3];                                     // 0x0004(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_JA5J[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_FIEF[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptDataInterfaceInfo
{
	...
	unsigned char                                      UnknownData_CONQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraSystemScalabilityOverride : public FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_444X[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FVMExternalFunctionBindingInfo
{
	...
	unsigned char                                      UnknownData_1QJO[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraScriptDataInterfaceCompileInfo
{
	...
	unsigned char                                      UnknownData_RGPD[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V4GR[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraDataSetProperties
{
	...
	unsigned char                                      UnknownData_9AVB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVMExecutableData
{
	...
	unsigned char                                      UnknownData_M3F1[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IKLT[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VW9Y[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPD4[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
