...
struct FMagicLeapImageTargetState
{
	...
	unsigned char                                      UnknownData_JSND[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapImageTargetSettings
{
	...
	unsigned char                                      UnknownData_33HI[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
