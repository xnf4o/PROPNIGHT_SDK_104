...
struct FFMODAttenuationDetails
{
	...
	unsigned char                                      UnknownData_8M8L[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFMODProjectLocale
{
	...
	unsigned char                                      UnknownData_XTKJ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8O3F[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
