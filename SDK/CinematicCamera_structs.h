...
struct FCameraLookatTrackingSettings
{
	...
	unsigned char                                      UnknownData_KQOF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N4FN[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R79Z[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraTrackingFocusSettings
{
	...
	unsigned char                                      UnknownData_Y7PK[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraFocusSettings
{
	...
	unsigned char                                      UnknownData_E30A[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0X9C[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8HP5[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EMDJ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FNamedFilmbackPreset
{
	...
	unsigned char                                      UnknownData_LCLF[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
