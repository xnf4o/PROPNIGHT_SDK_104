...
struct FMovieSceneCameraAnimSectionData
{
	...
	unsigned char                                      UnknownData_B8RD[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionData
{
	...
	unsigned char                                      UnknownData_NV6V[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3OKN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSourceTrigger
{
	...
	unsigned char                                      UnknownData_75PN[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_74FJ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSourceTriggerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_FTAB[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_956X[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventSectionData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_8J05[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_41UH[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	unsigned char                                      UnknownData_SG29[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NMLX[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L5L0[0x2];                                     // 0x00CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_88ZU[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JE2D[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieSceneStringChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_X7GI[0x67];                                    // 0x0039(0x0067) MISSED OFFSET (PADDING)
...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_K4W9[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_226D[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_N0JF[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DScaleKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_QJ10[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DRotationKeyStruct : public FMovieSceneKeyStruct
{
	...
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_VBSE[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DLocationKeyStruct : public FMovieSceneKeyStruct
{
	struct FVector                                     Location;                                                  // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WQ84[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformTemplateData
{
	...
	unsigned char                                      UnknownData_Z23T[0x3];                                     // 0x0641(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PYVH[0x7];                                     // 0x0649(0x0007) MISSED OFFSET (PADDING)
...
{
	TArray<struct FFrameNumber>                        KeyTimes;                                                  // 0x0008(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_7O2H[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMovieSceneActorReferenceKey>        KeyValues;                                                 // 0x0040(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_TSX5[0x60];                                    // 0x0050(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	unsigned char                                      UnknownData_19XV[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	struct FFrameNumber                                SectionStartTime;                                          // 0x0040(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_VP2H[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_NXG3[0x1C];                                    // 0x001C(0x001C) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_PSGL[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventTriggerData
{
	...
	unsigned char                                      UnknownData_O6N5[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_C092[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_22Q2[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneComponentMaterialSectionTemplate : public FMovieSceneParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_IV4X[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieScenePrimitiveMaterialTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_BBAA[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_ULUN[0x3];                                     // 0x02BD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_0IEC[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneVectorKeyStructBase : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_JM41[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZJCR[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorKeyStruct : public FMovieSceneVectorKeyStructBase
{
	...
	unsigned char                                      UnknownData_Y8QD[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
