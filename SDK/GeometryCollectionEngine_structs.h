...
struct FChaosCollisionEventRequestSettings
{
	...
	unsigned char                                      UnknownData_YUZX[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosBreakingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_K1S0[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosTrailingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_X0KP[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGeomComponentCacheParameters
{
	...
	unsigned char                                      UnknownData_APEQ[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F7IC[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C0WZ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M4Q9[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DAJX[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C9IN[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VER1[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GCEL[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_07ES[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionDebugDrawActorSelectedRigidBody
{
	...
	unsigned char                                      UnknownData_88GQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGeometryCollectionSizeSpecificData
{
	...
	unsigned char                                      UnknownData_YPS3[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChaosCollisionEventData
{
	...
	unsigned char                                      UnknownData_MK7P[0x14];                                    // 0x0044(0x0014) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionSource
{
	...
	unsigned char                                      UnknownData_VRLF[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
