...
struct FSubmixEffectDynamicProcessorFilterSettings
{
	...
	unsigned char                                      UnknownData_DLSY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubmixEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_MM7Q[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I484[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YKK7[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FSubmixEffectEQBand
{
	...
	unsigned char                                      UnknownData_EC07[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubmixEffectReverbSettings
{
	...
	unsigned char                                      UnknownData_E7CR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BMYD[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KRJX[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
