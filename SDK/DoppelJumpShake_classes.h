...
class UDoppelJumpShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass DoppelJumpShake.DoppelJumpShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_DoppelJumpShake(int EntryPoint);
};
