...
{
public:
	unsigned char                                      UnknownData_LV5N[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N2JA[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	struct FString StringToSha1(const struct FString& StringToHash);
	struct FString StringToMd5(const struct FString& StringToHash);
	struct FString PercentEncode(const struct FString& Source);
	TEnumAsByte<VaRest_EVaRestHttpStatusCode> HTTPStatusIntToEnum(int StatusCode);
	struct FVaRestURL GetWorldURL(class UObject* WorldContextObject);
	struct FString GetVaRestVersion();
...
public:
	...
	unsigned char                                      UnknownData_5658[0x40];                                    // 0x0048(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R157[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LK68[0xF];                                     // 0x00A1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9JDI[0x30];                                    // 0x00B8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CCGQ[0xD0];                                    // 0x00F8(0x00D0) MISSED OFFSET (PADDING)
	...
	VaRest_EVaRestRequestVerb GetVerb();
...
public:
	...
	unsigned char                                      UnknownData_A3NV[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
