...
class UFlashWidget_C : public UUserWidget
{
public:
	...
	class UImage*                                      SceneTexture;                                              // 0x0278(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass FlashWidget.FlashWidget_C");
		return ptr;
	}



	void FlashCapture(float PlaybackSpeed, bool Granny, bool MarioStun, bool Grenade);
	void ExecuteUbergraph_FlashWidget(int EntryPoint);
};
