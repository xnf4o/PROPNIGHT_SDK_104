...
{
	unsigned char                                      UnknownData_JOGX[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0MEJ[0xF];                                     // 0x0031(0x000F) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NSXA[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G4XZ[0x28];                                    // 0x0020(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AXEZ[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FMagicLeapMeshBlockRequest
{
	...
	unsigned char                                      UnknownData_D9DP[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMagicLeapMeshBlockInfo
{
	...
	unsigned char                                      UnknownData_7XTB[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q6ZT[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
struct FMagicLeapRaycastHitResult
{
	...
	unsigned char                                      UnknownData_I99O[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapRaycastQueryParams
{
	...
	unsigned char                                      UnknownData_5HY9[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapHeadTrackingState
{
	...
	unsigned char                                      UnknownData_7CZM[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapResult
{
	...
	unsigned char                                      UnknownData_ZCGB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
