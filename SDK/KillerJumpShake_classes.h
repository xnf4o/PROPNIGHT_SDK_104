...
class UKillerJumpShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass KillerJumpShake.KillerJumpShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_KillerJumpShake(int EntryPoint);
};
