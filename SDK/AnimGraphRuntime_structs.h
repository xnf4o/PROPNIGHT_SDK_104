...
struct FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_02OI[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IHUU[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_Z22O[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S4D5[0x88];                                    // 0x0058(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_OFCO[0x68];                                    // 0x00E8(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FYVQ[0x30];                                    // 0x0190(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimPhysSphericalLimit
{
	...
	unsigned char                                      UnknownData_8Y46[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FRotationRetargetingInfo
{
	...
	unsigned char                                      UnknownData_Z0E0[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BBJA[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NOUU[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X61W[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZJCE[0x3];                                     // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VH0E[0x7];                                     // 0x0129(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimPhysConstraintSetup
{
	...
	unsigned char                                      UnknownData_PZ2G[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B9FI[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_KO49[0x60];                                    // 0x00D0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W00I[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YUTJ[0x2];                                     // 0x0242(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3224 : 1;                                      // 0x0245(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_1KTA[0xA];                                     // 0x0246(0x000A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRotationRetargetingInfo                    RetargetingSettings;                                       // 0x0250(0x0130) (Edit, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I0HD[0xC0];                                    // 0x0380(0x00C0) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ZVYG[0x4];                                     // 0x00C0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GV19[0x2];                                     // 0x00C6(0x0002) MISSED OFFSET (PADDING)
...
struct FBlendBoneByChannelEntry
{
	...
	unsigned char                                      UnknownData_XA58[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendBoneByChannel : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_4G9X[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_730V[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J65U[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_E85X[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E0YU[0x50];                                    // 0x0048(0x0050) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_OQ1J[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByEnum : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_SCQL[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByInt : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_83OU[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpaceEvaluator : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_40WP[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_ALCX[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y10B[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y3IK[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FBoneSocketTarget
{
	...
	unsigned char                                      UnknownData_287A[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBoneReference                              BoneReference;                                             // 0x0004(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_LNDE[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_CCDIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_IG11[0xB];                                     // 0x00D5(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BTVK[0x6];                                     // 0x016A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraint
{
	...
	unsigned char                                      UnknownData_91IH[0x7];                                     // 0x0015(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_Constraint : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_09ZE[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_XS0C[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_RUT8[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AFJS[0x1B4];                                   // 0x0024(0x01B4) MISSED OFFSET (PADDING)
...
struct FAnimNode_CurveSource : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_UX3I[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6GZT[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G2HI[0x6];                                     // 0x018A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_HandIKRetargeting : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_F4DN[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_9ZUE[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S6XX[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XXBW[0x30];                                    // 0x0090(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimNode_LegIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_FEDK[0x18];                                    // 0x00E0(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AVHM[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FIKChain
{
	unsigned char                                      UnknownData_SQZ5[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FIKChainLink
{
	unsigned char                                      UnknownData_UR3I[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
{
	struct FBoneReference                              BoneToModify;                                              // 0x00C8(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QAAG[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_65TT[0x2];                                     // 0x015E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K916[0x34];                                    // 0x017C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_MakeDynamicAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_AP46[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_B8R5[0x6];                                     // 0x0102(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyCurve : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_FMD9[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_HAFX[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_MultiWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_DSZS[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2TSY[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_YP2C[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_05VO[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseBlendNode : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_NMNX[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseByName : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_BB30[0xC];                                     // 0x008C(0x000C) MISSED OFFSET (PADDING)
...
struct FPoseDriverTarget
{
	...
	unsigned char                                      UnknownData_AR0T[0x5];                                     // 0x0023(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WGCW[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MSTS[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
...
struct FRBFParams
{
	...
	unsigned char                                      UnknownData_XWPN[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HYL6[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_YAMY[0x30];                                    // 0x00C0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DDSG[0x1];                                     // 0x012F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OR4V[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseSnapshot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_NK9A[0x3F];                                    // 0x0051(0x003F) MISSED OFFSET (PADDING)
...
struct FRandomPlayerSequenceEntry
{
	...
	unsigned char                                      UnknownData_3WEC[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_RandomPlayer : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_VLI8[0x50];                                    // 0x0020(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5URJ[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_RefPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_D9PN[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W6CM[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_6NXR[0x98];                                    // 0x00D0(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ISAA[0x1];                                     // 0x01FB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JX94[0x3];                                     // 0x01FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QJ9W[0x448];                                   // 0x0208(0x0448) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotateRootBone : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_508X[0xC];                                     // 0x0094(0x000C) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_HX8F[0x2];                                     // 0x00EE(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_BOL0[0x4];                                     // 0x0188(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZVEW[0x2];                                     // 0x018E(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_FMME[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z55K[0x17];                                    // 0x0061(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_BQV4[0x1];                                     // 0x0047(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UB3I[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_Slot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_OMTY[0x1F];                                    // 0x0029(0x001F) MISSED OFFSET (PADDING)
...
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_Y8VY[0x2];                                     // 0x00EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JJPI[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P906[0x128];                                   // 0x0148(0x0128) MISSED OFFSET (PADDING)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_UTDT[0x3C];                                    // 0x00E8(0x003C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ON2[0x3];                                     // 0x0125(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HT46[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TJIY[0x2];                                     // 0x0116(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8GRK[0x34];                                    // 0x022C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwistCorrectiveNode : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_85HH[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_WK75[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UC2B[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M7WV[0xD];                                     // 0x01D3(0x000D) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_GZF5 : 2;                                      // 0x0031(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_XA0S[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       AlphaCurveName;                                            // 0x0088(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                       // 0x0090(0x0030) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_IFEB[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HZRQ[0x2A0];                                   // 0x0760(0x02A0) MISSED OFFSET (PADDING)
...
struct FPositionHistory
{
	...
	unsigned char                                      UnknownData_GQ1S[0x1C];                                    // 0x0014(0x001C) MISSED OFFSET (PADDING)
...
struct FRBFTarget : public FRBFEntry
{
	...
	unsigned char                                      UnknownData_OKX9[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0RV4[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
