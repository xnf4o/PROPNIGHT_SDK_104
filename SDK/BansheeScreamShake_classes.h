...
class UBansheeScreamShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BansheeScreamShake.BansheeScreamShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BansheeScreamShake(int EntryPoint);
};
