...
class UKillerWalkGrabbedShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass KillerWalkGrabbedShake.KillerWalkGrabbedShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_KillerWalkGrabbedShake(int EntryPoint);
};
