...
class UAlarmShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass AlarmShake.AlarmShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AlarmShake(int EntryPoint);
};
