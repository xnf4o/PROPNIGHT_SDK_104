...
class UJumpShakeForProps_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass JumpShakeForProps.JumpShakeForProps_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_JumpShakeForProps(int EntryPoint);
};
