...
class AFootprint_Actor_C : public AActor
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0220(0x0008) (ZeroConstructor, Transient, DuplicateTransient, UObjectWrapper)
	class UDecalComponent*                             FootprintDecal;                                            // 0x0228(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Footprint_Actor.Footprint_Actor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Footprint_Actor(int EntryPoint);
};
