...
class UBansheeJumpShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BansheeJumpShake.BansheeJumpShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BansheeJumpShake(int EntryPoint);
};
