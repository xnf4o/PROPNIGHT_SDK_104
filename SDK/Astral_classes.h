...
// 0x0B49 (FullSize[0x0C31] - InheritedSize[0x00E8])
class UAstral_C : public UKillerSpell_C
{
public:
	...
	unsigned char                                      UnknownData_S0IA[0xB];                                     // 0x00F5(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8SNP[0x4];                                     // 0x0BB4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UEU9[0x2];                                     // 0x0BD6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2OXX[0x4];                                     // 0x0BF4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U6U7[0x7];                                     // 0x0C01(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Astral.Astral_C");
		return ptr;
	}
	...
	void Consume();
	void OnInvoke();
	void ExecuteUbergraph_Astral(int EntryPoint);
};
