...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_GDW7[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_12IT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_DM0T[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_S2EH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M3ER[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3KF1[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0VP7[0x10];                                    // 0x0760(0x0010) MISSED OFFSET (PADDING)
...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_ISAM[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
