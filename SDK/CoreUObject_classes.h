...
{
public:
	unsigned char                                      UnknownData_SY23[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q6UN[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_REAE[0x10];                                    // 0x00B0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JJLH[0x78];                                    // 0x0028(0x0078) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DXVO[0x180];                                   // 0x00B0(0x0180) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_PZLZ0HV35N[0x01];                                      // 0x00A7(0x0001) NOT AUTO-GENERATED PROPERTY
	uint16_t_t                                         ParmsSize;                                                 // 0x00A8(0x0002) NOT AUTO-GENERATED PROPERTY
	...
	class FProperty*                                   FirstPropertyToInit;                                       // 0x00B0(0x0008) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_BMH8BFQP6T[0x04];                                      // 0x00C4(0x0004) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_IAWQ[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VLD8[0x80];                                    // 0x0230(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4QQP[0xB8];                                    // 0x0028(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_17PQ[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FO0V[0x1B8];                                   // 0x0230(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PKNJ[0xC8];                                    // 0x0028(0x00C8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SUR2[0x1B8];                                   // 0x00E0(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DG7D[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_E3V0[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5ERH[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XNK2[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RW79[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ABX0[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FGWA[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QVQF[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6SC9[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KNZV[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TGFW[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W75L[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EZLV[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_92O8[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GT4H[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OU0P[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NDQ5[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
