...
// BlueprintGeneratedClass RabbitWalkShake.RabbitWalkShake_C
// 0x002C (FullSize[0x01AC] - InheritedSize[0x0180])
class URabbitWalkShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass RabbitWalkShake.RabbitWalkShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_RabbitWalkShake(int EntryPoint);
};
