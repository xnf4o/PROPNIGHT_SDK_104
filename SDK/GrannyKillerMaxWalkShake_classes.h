...
class UGrannyKillerMaxWalkShake_C : public UMatineeCameraShake
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass GrannyKillerMaxWalkShake.GrannyKillerMaxWalkShake_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GrannyKillerMaxWalkShake(int EntryPoint);
};
